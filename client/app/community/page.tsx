...
// Mock blockchain research papers
const mockPapers = [
  {
    id: "paper-001",
    title: "Decentralized Finance (DeFi): Opportunities and Challenges in the Blockchain Ecosystem",
    author: "Dr. Sarah Chen",
    institution: "MIT Blockchain Research Lab",
    date: "2023-10-15",
    category: "Blockchain Economics",
    tags: ["DeFi", "Smart Contracts", "Liquidity Mining"],
    abstract:
    ...
    price: 25,
    verified: true,
    imageUrl: "/images/research-sample.png",
    transactionHash: "0x7a9d8e3b2f5c8d1a4e6b7c9d8e1f2a3b4c5d6e7f",
  },
  {
    id: "paper-002",
    title: "Consensus Mechanisms: A Comparative Analysis of Proof-of-Work and Proof-of-Stake",
    author: "Prof. Michael Rodriguez",
    institution: "Stanford Distributed Systems Group",
    date: "2023-08-22",
    category: "Blockchain Technology",
    tags: ["Consensus", "PoW", "PoS", "Energy Efficiency"],
    abstract:
  ...
  {
    id: "paper-003",
    title: "NFTs and Digital Ownership: Implications for Intellectual Property in the Metaverse",
    author: "Dr. Emily Johnson",
    institution: "Berkeley Blockchain Initiative",
    date: "2023-11-05",
    category: "Digital Assets",
    tags: ["NFTs", "Metaverse", "IP Rights", "Digital Ownership"],
    abstract:
  ...
  {
    id: "paper-004",
    title: "Blockchain Interoperability: Bridging Protocols and Cross-Chain Communication",
    author: "Dr. Alex Thompson",
    institution: "ETH Zurich Cryptography Group",
    date: "2023-09-18",
    category: "Blockchain Technology",
    tags: ["Interoperability", "Cross-Chain", "Bridges", "Security"],
    abstract:
  ...
  {
    id: "paper-005",
    title: "Zero-Knowledge Proofs in Blockchain Privacy: Applications and Limitations",
    author: "Prof. David Kim",
    institution: "Imperial College Blockchain Center",
    date: "2023-12-01",
    category: "Cryptography",
    tags: ["ZK-Proofs", "Privacy", "Scalability", "ZK-Rollups"],
    abstract:
    ...
    isPremium: true,
    price: 35,
    verified: false, // Still pending verification
    imageUrl: "/images/research-sample.png",
...
export default function CommunityPage() {
  ...
  const featuredPaper = mockPapers.reduce((prev, current) => (prev.trustScore > current.trustScore ? prev : current))
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="relative z-10 border-b border-gray-800 py-8 bg-gradient-to-r from-gray-900 via-mintellect-dark to-gray-900">
