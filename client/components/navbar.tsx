    ...
    <div className="bg-black/80 backdrop-blur-md border-b border-blue-900/30 py-3">
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <Link href="/dashboard" className="flex items-center gap-2">
          {/* Empty link for dashboard navigation */}
        </Link>

        {/* Right side - Wallet and mobile menu */}
        <div className="flex items-center gap-3">
          {/* Connect Wallet Button - Only show on dashboard pages */}
          {isDashboardPage && (
            <button
            ...
            >
              ...
              {walletConnected && <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse ml-1"></span>}
            </button>
          )}
      ...
      {/* Mobile menu - Only show on dashboard pages */}
