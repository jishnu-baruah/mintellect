    ...
    >
      ...
      <main className="pt-20">
        ...
        <section
          id="hero"
          ref={heroRef}
          className="relative min-h-[100vh] flex items-center justify-center overflow-visible pt-12 pb-0 sm:pt-16 md:pt-20 lg:pt-24 transition-all duration-1000"
        >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute -inset-10" // Changed from inset-0 to -inset-10 to make it larger
                      style={{
                        background:
                  ...
                  <motion.div
                    ...
                    animate={{
                      boxShadow: [
                        "inset 0 0 15px rgba(59, 130, 246, 0.1), 0 0 15px rgba(59, 130, 246, 0.1)",
                        "inset 0 0 20px rgba(59, 130, 246, 0.2), 0 0 20px rgba(59, 130, 246, 0.2)",
                        "inset 0 0 15px rgba(59, 130, 246, 0.1), 0 0 15px rgba(59, 130, 246, 0.1)",
                      ],
                    }}
                  ...
                  <div className="text-center relative z-10">
                    {/* AI+Web3.0 badge */}
                    <motion.div
                      className="inline-flex items-center bg-black/40 backdrop-blur-sm rounded-full px-4 py-1.5 text-xs text-blue-300 font-medium mb-8 mx-auto"
                      animate={{
                        boxShadow: [
                      ...
                      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                        <div className="flex flex-col items-center">
                          <div className="flex items-center justify-center w-full">
                            <div className="flex items-center justify-center w-full">
                              <div className="text-center w-[200px] sm:w-[240px] md:w-[280px] lg:w-[320px] overflow-visible">
                              ...
                              <div className="whitespace-nowrap tracking-normal px-1 letter-spacing-tight">
                                Your Research
                              </div>
                            </div>
                          </div>
                    ...
                    >
                      <div className="relative inline-block">
                        ...
                        <motion.h2 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold">
                          <motion.span
